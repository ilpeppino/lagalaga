...
export const ErrorCodes = {
  ...
  CONFLICT_ACCOUNT_PROVIDER: 'CONFLICT_ACCOUNT_PROVIDER',
  ACCOUNT_LINK_SAME_PROVIDER_DUPLICATE: 'ACCOUNT_LINK_SAME_PROVIDER_DUPLICATE',
  ACCOUNT_LINK_INVALID_STATE: 'ACCOUNT_LINK_INVALID_STATE',
